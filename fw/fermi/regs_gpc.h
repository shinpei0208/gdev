...
#define BC_CTXCTL_BASE 0x41a000
#define GPC_BASE 0x502000
#define GPC_OFFSET 0x8000


#define HUB(n) (PG_09_BASE + FUC_##n)
//#define FUC_UNITS 0x604//0-4GPC_COUNT, 16-20 ROPC_COUNT

#define NVC0_CTXCTL(n) NVC0_CTXCTL_##n

#define BC_CTXCTL(n) (BC_CTXCTL_##n + BC_CTXCTL_BASE)
#define BC_CTXCTL_CMD 0x504
#define BC_CTXCTL_DATA 0x500
...
// GPC
#define FUC_UNITS 0x608
#define FUC_MYINDEX 0x618
